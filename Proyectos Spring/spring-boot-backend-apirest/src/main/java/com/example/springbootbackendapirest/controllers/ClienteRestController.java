...
import com.example.springbootbackendapirest.models.serivces.IClienteService;
...
public class ClienteRestController {
    ...
    public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) { //los datos vienen en formato json // binding result tiene todos los mensajes de error
    ...
    /*        List<String> errors = new ArrayList<>();
            ...
            List<String> errors = result.getFieldErrors().stream().map(fieldError -> {
    ...
    /*        List<String> errors = new ArrayList<>();
        ...
        if (clienteActual == null) {
            response.put("mensaje", "Error, no se puede editar , el cliente no existe en la base de datos");
            return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
        }
        try {
